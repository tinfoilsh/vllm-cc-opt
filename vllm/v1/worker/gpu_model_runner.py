        ...
        *,
        ...
        ccbench_instant(
            "ccbench.output.worker.submit",
            {
                ...
                "fast_count_publication": self.fast_count_publication,
            },
        )
        if self.fast_count_publication:
            ccbench_instant(
                "ccbench.output_worker.count_only.submit",
                {
                    "sampled_token_ids_bytes": tensor_nbytes(sampled_token_ids),
                    "sampled_token_ids_shape": tensor_shape(sampled_token_ids),
                    "pin_memory": self.pin_memory,
        ...
        while True:
            ...
            try:
                with ccbench_span(
                    ...
                    if self.fast_count_publication:
                        with ccbench_span(
                            "ccbench.output_worker.count_only.ready",
                            {
                                ...
                                "discard_req_indices": len(
                                    task.invalid_req_indices
                                ),
                                "has_logprobs": task.logprobs_tensors is not None,
                                "has_routed_experts": (
                                    task.routed_experts is not None
                                ),
                                "count_ready_before_full_result": (
                                    not task.publication.done()
                                ),
                            },
                        ):
                            valid_sampled_token_count = (
                                _calc_valid_sampled_token_count(
                                    sampled_token_ids_cpu,
                                    task.vocab_size,
                                    task.invalid_req_indices,
                                )
...
class GPUModelRunner(
        ...
        if self.speculative_config is not None or self.cc_output_worker_enabled:
            ...
            ccbench_instant(
                "ccbench.spec.config",
                {
                    ...
                    "cc_output_worker_requested": cc_output_worker_requested,
                    "cc_output_worker_cc_enabled": cc_output_worker_cc_enabled,
                    "cc_output_worker_enabled": self.cc_output_worker_enabled,
                    "cc_spec_count_fast_publication_requested": (
                        cc_spec_count_fast_publication_requested
                    ),
                    "cc_spec_count_fast_publication_enabled": (
                        self.cc_spec_count_fast_publication_enabled
                    ),
    ...
    def _prepare_input_ids(
        ...
        with ccbench_span(
            ...
            {
                "object_name": "sampled_tokens_index_tensor",
                "source": "raw_tensor_to",
                "phase": "prepare_input_ids",
                "bytes": len(sample_flattened_indices) * 8,
                "dtype": "torch.int64",
                "pin_memory": self.pin_memory,
            },
        ):
        ...
        with ccbench_span(
            "ccbench.metadata.copy_to_gpu",
            {
                "object_name": "prev_common_req_indices_tensor",
                "source": "raw_tensor_to",
                "phase": "prepare_input_ids",
                "bytes": len(prev_indices) * 8,
                "dtype": "torch.int64",
                "pin_memory": self.pin_memory,
            },
        ):
        ...
        with ccbench_span(
            "ccbench.metadata.copy_to_gpu",
            {
                "object_name": "draft_tokens_index_tensor",
                "source": "raw_tensor_to",
                "phase": "prepare_input_ids",
                "bytes": len(spec_flattened_indices) * 8,
                "dtype": "torch.int64",
                "pin_memory": self.pin_memory,
            },
        ):
        ...
        with ccbench_span(
            "ccbench.metadata.copy_to_gpu",
            {
                "object_name": "prev_draft_token_indices_tensor",
                "source": "raw_tensor_to",
                "phase": "prepare_input_ids",
                "bytes": len(prev_draft_token_indices) * 8,
                "dtype": "torch.int64",
                "pin_memory": self.pin_memory,
            },
        ):
    ...
    def _prepare_inputs(
        ...
        if self.num_accepted_tokens_event is not None and not cc_mtp_decode_metadata_fastpath:
    ...
    def sample_tokens(
        ...
        with record_function_or_nullcontext(
            ...
            if self._can_use_cc_output_worker():
    ...
    def _copy_valid_sampled_token_count(
        ...
        if self.use_async_spec_decode and self._can_use_cc_output_worker():
            ...
            ccbench_instant(
                ...
                {
                    "reason": "cc_output_worker_publication",
    ...
    def _get_valid_sampled_token_count(self) -> list[int]:
        ...
        if (
            ...
            event_name = (
                "ccbench.spec.valid_count.wait_output_worker_count"
                if self.cc_spec_count_fast_publication_enabled
                else "ccbench.spec.valid_count.wait_output_worker_full"
            )
            with ccbench_span(
                event_name,
                {
                    "num_reqs": int(prev_sampled_token_ids.shape[0]),
                    "fast_count_publication": (
                        self.cc_spec_count_fast_publication_enabled
                    ),
                    "publication_done": publication.done(),
                    "count_done": publication.valid_sampled_token_count_done(),
                },
            ):
