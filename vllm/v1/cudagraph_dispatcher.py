...
class CudagraphDispatcher:
    ...
    def initialize_cudagraph_keys(
        ...
        # Draft-model FULL keys: drafter chain steps are uniform decode with
        # query_len=1, so add FULL keys for capture sizes up to max_num_seqs.
        # (P5 / upstream PR #34880.)
