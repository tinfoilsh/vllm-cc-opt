...
if TYPE_CHECKING:
    ...
    VLLM_DCP_FP8_A2A: bool = False
    VLLM_DCP_FP8_A2A_MIN_TOKENS: int = 1024
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Quantize large DCP output shards before their owner-local A2A exchange.
    "VLLM_DCP_FP8_A2A": lambda: bool(int(os.getenv("VLLM_DCP_FP8_A2A", "0"))),
    "VLLM_DCP_FP8_A2A_MIN_TOKENS": lambda: int(
        os.getenv("VLLM_DCP_FP8_A2A_MIN_TOKENS", "1024")
    ),
